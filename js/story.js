...
window.GAME_STORY = {
  ...
  p4: { type:"narration", text:"你是为了毕业设计来的——研究城南老街区的改造。这家店，是你考察的第一站。", next:"p5" },
  p5: { type:"narration", text:"那是你第一次见到她。", next:"c1_1" },
  ...
  c1_21: { type:"narration", text:"结账时，你看见她躲在柜台后面，假装整理收据，却偷偷用余光瞄你。", next:"c1_22" },
  c1_22: { type:"narration", text:"你平时习惯了图纸和模型，生活像一条精确的直线。但这个像受惊兔子一样的女孩，莫名在你的直线上画了一个小圈。", next:"c2_1" },

  // ===== 第二章 =====
  c2_1: { chapter:"第二章 · 雨中的便利店", type:"narration", text:"一周后的傍晚，城市毫无预兆地下起了暴雨。", next:"c2_2" },
  c2_2: { type:"narration", text:"你在老街量尺寸，没带伞，跑进街角的便利店避雨，浑身湿了大半。", next:"c2_3" },
  ...
  c2_9: { type:"narration", text:"你靠在窗边，看着她熟练地给一个老爷爷热便当，又笑着送走带小孩的妈妈。", next:"c2_10" },
  c2_10: { type:"narration", text:"她好像永远有用不完的精力，对每个人都软软地笑。你忽然觉得，她像这灰暗雨天里，唯一亮着的一盏暖灯。", next:"c2_11" },
  c2_11: { type:"dialogue", speaker:"林夏", text:"你要不要……喝点热的？我请客。", next:"c2_12" },
  c2_12: { type:"narration", text:"她说完又后悔了，赶紧补一句——", next:"c2_13" },
  c2_13: { type:"dialogue", speaker:"林夏", text:"就是、就是店里有微波炉热牛奶，不要钱的，员工福利那种……", next:"c2_choice2" },
  c2_choice2: {
  ...
  c2_after2: { type:"narration", text:"她去热牛奶的时候，偷偷回头看了你三次。", next:"c2_14" },
  c2_14: { type:"narration", text:"你们坐在便利店窗边的高脚凳上，看雨砸在玻璃上。", next:"c2_15" },
  c2_15: { type:"dialogue", speaker:"林夏", text:"雨好大。", next:"c2_16" },
  c2_16: { type:"dialogue", speaker:"林夏", text:"……你住附近吗？", next:"c2_choice3" },
  c2_choice3: {
    type:"dialogue", speaker:"你", text:"（怎么回答？）",
    choices: [
  ...
  c2_after3: { type:"dialogue", speaker:"林夏", text:"其实……我下周六还会去知更鸟。", next:"c2_17" },
  c2_17: { type:"dialogue", speaker:"林夏", text:"就是、就是顺便告诉你一下。", next:"c2_18" },
  c2_18: { type:"narration", text:"她说顺便两个字的时候，手指在围裙上攥紧了。", next:"c2_19" },
  c2_19: { type:"dialogue", speaker:"林夏", text:"如果你……如果你也去的话。", next:"c2_20" },
  c2_20: { type:"narration", text:"雨小了一些。你撑着她给的鸭子伞，走进夜色里。", next:"c2_21" },
  c2_21: { type:"narration", text:"回头看时，便利店的灯还亮着。她站在玻璃后面，正看着你的方向。", next:"c2_22" },
  c2_22: { type:"narration", text:"——她没有发现，自己已经在玻璃上，用手指画了一颗小小的心。", next:"c2_23" },
  c2_23: { type:"narration", text:"你捏着那把伞的伞柄，觉得心里某个坚硬的角落，被这把幼稚的鸭子伞撬开了一丝缝隙。", next:"c3_1" },
  ...
  c3_17: { type:"narration", text:"四月，你的毕业设计进入了最烦躁的阶段。你画废了无数张图纸，只有下午三点的拿铁，能让你稍微喘口气。", next:"c3_18" },
  c3_18: { type:"narration", text:"那天纸条上写着：「听说学建筑的都很辛苦，但我相信你设计的房子一定很漂亮。加油！」", next:"c3_19" },
  c3_19: { type:"narration", text:"你喝了一口奶泡，忽然觉得，好像也没那么难熬了。你开始习惯生活中有这样一个叫林夏的女孩，像习惯呼吸一样自然。", next:"c4_1" },
  ...
  c4_a11: { type:"narration", text:"你合上本子。心跳得有点快。你第一次知道，原来被人这样小心翼翼地捧在手心里，是这种感觉。", next:"c4_after" },
  ...
  c4_12: { type:"narration", text:"——她不再写那些我喜欢他之类的话了。她怕你看到了，又怕你没看到。", next:"c4_13" },
  c4_13: { type:"narration", text:"而你看着那些小心翼翼的纸条，心里竟然生出一丝不忍。你不想她因为害怕而收起那份心意，你甚至……有点贪恋那份心意。", next:"c5_1" },
  ...
  c5_10: { type:"narration", text:"你看着她湿透的肩膀，心里那种陌生的保护欲突然涌了上来。你不想让她受一点委屈，哪怕只是淋一滴雨。", next:"c5_11" },
  ...
  c6_19: { type:"narration", text:"你甚至想过，要在你的毕业设计里，给她留一个带风铃的阳台。你发现，你早就沦陷了。", next:"c6_20" },
  c6_20: { type:"dialogue", speaker:"你", text:"如果以后睡不着，随时可以打给我。", next:"c6_21" },
  c6_21: { type:"dialogue", speaker:"林夏", text:"……真的吗？不管多晚？", next:"c6_22" },
  c6_22: { type:"dialogue", speaker:"你", text:"不管多晚。", next:"c6_23" },
  c6_23: { type:"narration", text:"这句承诺，后来她真的验证了很多次。", next:"c7_1" },
  ...
  c7_a8: { type:"narration", text:"你瞥见笔记本最新一页写着：「他今天没来咖啡馆，是不是因为我昨天表现得太明显了？」", next:"c7_a9" },
  c7_a9: { type:"narration", text:"你心里一酸，原来她生着病，还在担心这种事。", next:"c7_a10" },
  c7_a10: { type:"narration", text:"你把粥热好，把药放在她手边。", next:"c7_a11" },
  c7_a11: { type:"dialogue", speaker:"林夏", text:"……谢谢。", next:"c7_a12" },
  c7_a12: { type:"narration", text:"她喝粥的时候偷偷看你，被你撞见了就低头，再偷偷抬眼。", next:"c7_choice2" },
  c7_choice2: {
    type:"dialogue", speaker:"你", text:"（怎么回应？）",
    choices: [
  ...
  c7_after: { type:"narration", text:"你坐在她床边，看着她把药吃了，把被子掖好。", next:"c7_a13" },
  c7_a13: { type:"dialogue", speaker:"林夏", text:"你……要走了吗？", next:"c7_a14" },
  c7_a14: { type:"narration", text:"她问这句话的时候，声音里有藏不住的紧张。", next:"c7_choice3" },
  c7_choice3: {
    type:"dialogue", speaker:"你", text:"（怎么回答？）",
    choices: [
  ...
  c7_after2: { type:"narration", text:"窗外的天，一点一点地暗下来，又一点一点地亮起来。", next:"c7_a15" },
  c7_a15: { type:"narration", text:"你们谁都没有说话。但她睡着了之后，手一直攥着你的衣角。", next:"c7_a16" },
  c7_a16: { type:"narration", text:"——攥得很紧，像是怕一松手，你就会消失。", next:"c7_a17" },
  c7_a17: { type:"narration", text:"第二天早上，阳光洒进房间。她还在睡，眉头舒展，嘴角带着一点点弧度。", next:"c7_a18" },
  c7_a18: { type:"narration", text:"你轻轻抽出被她攥住的衣角，留了一张字条：「粥在锅里，药在桌上。下午三点见。」", next:"c7_a19" },
  c7_a19: { type:"narration", text:"下午三点，你推开咖啡馆的门。她站在吧台后，脸色好了很多，眼睛亮晶晶的。", next:"c8_1" },
  ...
  c8_b8: { type:"dialogue", speaker:"林夏", text:"那你……为什么不早说……", next:"c8_b9" },
  c8_b9: { type:"dialogue", speaker:"你", text:"因为我想等你自己说。", next:"c8_b10" },
  c8_b10: { type:"narration", text:"她抬起头，眼泪一颗一颗地掉下来。", next:"c8_c1" },
